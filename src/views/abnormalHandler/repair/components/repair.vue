  ...
  <div class="details">
    ...
    <div class="table_content">
      ...
      <div class="table" style="height: 100%">
        <cuTable :tableHeaders="tableColumnsData" :allDatas="tableData" :formatterVal="{}" :height="'94%'" :cuLoading="loading"></cuTable>
        <!--<el-table-->
          <!--:data="tableData"-->
          <!--border-->
          ...
          <!--<el-table-column prop="operation " label="操作" width="128">-->
            <!--<template slot-scope="scope">-->
              <!--<div @click="handleClick(scope.row)" style="cursor: pointer">-->
                ...
                <!--&lt;!&ndash; <span style="color:#ccc;">定位</span> &ndash;&gt;-->
              <!--</div>-->
            <!--</template>-->
          <!--</el-table-column>-->
          <!--<el-table-column v-for="(column, index) in tableColumnsData" :key="'tableColumn' + index"-->
                           <!--:prop=column.key-->
                           <!--:label=column.name-->
...
export default {
  ...
  methods: {
    ...
    list (params) {
      ...
      let kssj = year + '-' + month + "-" + day;
      let jssj = kssj + " 23:59:59";
      params = params || {"SSGS": "FFFFFFFFFFFFFFFFFFFFFFFFFFFFSP05", "KSSJ": kssj, "JSSJ": jssj, "SFCL": 1}
      request({
        url: apiPath.SN_GZQX_QXDMX,
        method: 'get',
        params: params
      }).then(res => {
...
//        })
    ...
    tableColumns(){
      this.tableColumnsData = [
        {'key': 'QXDBH', 'name':  '抢修单编号', 'minWidth': '128'},
        {'key': 'QXZDMC', 'name':  '抢修驻点名称', 'minWidth': '128'},
        {'key': 'QXDZTMC', 'name':  '抢修单状态名称', 'minWidth': '128'},
        {'key': 'LYMC', 'name':  '来源名称', 'minWidth': '128'},
        {'key': 'BXSJ', 'name':  '报修时间', 'minWidth': '128'},
        {'key': 'JDDJSJ', 'name':  '接单登记时间', 'minWidth': '128'},
        {'key': 'BXNR', 'name':  '报修内容', 'minWidth': '256'},
        {'key': 'TZQXSJ', 'name':  '通知抢修时间', 'minWidth': '128'},
        {'key': 'JLDDSJ', 'name':  '记录到达时间', 'minWidth': '128'},
        {'key': 'JLXFSJ', 'name':  '记录修复时间', 'minWidth': '128'},
        {'key': 'CLJGMS', 'name':  '处理结果描述', 'minWidth': '128'},
        {'key': 'GZDD', 'name':  '故障地点', 'minWidth': '128'},
        {'key': 'GZDJD', 'name':  '故障点经度', 'minWidth': '128'},
        {'key': 'GZDWD', 'name':  '故障点纬度', 'minWidth': '128'},
        {'key': 'GZSBMC', 'name':  '故障设备名称', 'minWidth': '128'},
        {'key': 'YHMC', 'name':  '用户名称', 'minWidth': '128'},
        {'key': 'SFCLMC', 'name':  '是否处理名称', 'minWidth': '128'},
        {'key': 'FZR', 'name':  '负责人', 'minWidth': '128'},
        {'key': 'LXDH', 'name':  '联系电话', 'minWidth': '128'},
      ];
    },
    handleCurrentChange(pageNum){
      ...
      this.tableShowData = this.tableData.slice(startIndex, endIndex);
      this.loading = false;
