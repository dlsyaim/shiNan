<template>
  <div class="details">
    <el-breadcrumb separator-class="el-icon-arrow-right">
         ...
         <el-breadcrumb-item>
             <span @click="back" class="back">三相均衡</span>
         </el-breadcrumb-item>
         <el-breadcrumb-item>
             详情
         </el-breadcrumb-item>
    ...
    <div class="table_content">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column fixed prop="relationship " label="查看电流曲线" width="128">
                ...
                <span style="color:#ccc;">查看电流曲线</span>
              </div>
               </template>
    ...
    <!-- 弹框 负载曲线-->
    <el-dialog width="90%" id="same_month" title="电流曲线" :visible.sync="showDialog">
      <div class="equipment">
        <div class="equipment_name">
          <span>设备名称:</span>
          <span>{{FHQXName}}</span>
