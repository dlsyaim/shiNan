<template>
  <div class="details">
    ...
    <div class="table_content">
      ...
      <div class="table_content_top">
        <span @click="dialogFormVisible = true">
          <img src="../../images/ic_file.png" alt /> 
        </span>
        <span @click="loadcure = true">
          <img src="../../images/ic_data.png" alt /> 负荷曲线
        </span>
        <span>
          <img src="../../images/ic_import.png" alt /> 数据导出
        </span>
      </div>
      <div class="table">
        <el-table
        ...
        >
          ...
          <el-table-column prop="sbbm" label="所属公司" width="128"></el-table-column>
          <el-table-column prop="sbmc" label="所属站房" width="128"></el-table-column>
          <el-table-column prop="ycljts" label="设备名称" width="128"></el-table-column>
          <el-table-column prop="bphljts" label="电压等级" width="128"></el-table-column>
          <el-table-column prop="pblx" label="额定容量(kVA)" width="128"></el-table-column>
          <el-table-column prop="edrl" label="使用性质" width="128"></el-table-column>
          <el-table-column prop="syxz" label="投运日期" width="128"></el-table-column>
          <el-table-column prop="xh" label="运维班组" width="128"></el-table-column>
          <el-table-column prop="dydj" label="运行状态" width="128"></el-table-column>
          <el-table-column prop="sccj" label="重要程度" width="128"></el-table-column>
          <el-table-column prop="whbzmc" label="专业分类" width="128"></el-table-column>
          <el-table-column prop="ywdwmc" label="负载情况" width="132"></el-table-column>
        </el-table>
        <el-pagination
                background
                prev-text="上一页"
    ...
    <!-- 弹框 负载曲线-->
    <el-dialog width="90%" style="margin-left:180px;" id="same_month" title="负荷曲线" :visible.sync="loadcure">
      <div class="equipment">
        <div class="equipment_name">
          <span>设备名称:</span>
          <span>华鹏成山1号变电</span>
...
<script>
import MyEcharts from "../../components/lineCharts"; //echarts
