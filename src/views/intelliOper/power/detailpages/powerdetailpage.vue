...
<template>
  <div class="details">
    <el-breadcrumb separator-class="el-icon-arrow-right">
         ...
         <el-breadcrumb-item>
             <span @click="back" class="back">功率因素</span>
         </el-breadcrumb-item>
         <el-breadcrumb-item>
             详情
         </el-breadcrumb-item>
    ...
    <div class="table_content">
      ...
      <!-- <div class="table_content_top">
        <span @click="getFZQXData">
          <img :src="calendarImg" alt /> 功率因素曲线
        </span>
        <span>
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column fixed prop="relationship " label="查看功率因素曲线" width="128">
              ...
              <template slot-scope="scope">
                ...
                <span style="color:#ccc;">查看功率因素曲线</span>
              </div>
               </template>
    ...
    <!-- 弹框 负载曲线-->
    <el-dialog width="90%" id="same_month" title="功率因素曲线" :visible.sync="showDialog">
      <div class="equipment">
        <div class="equipment_name">
          <span>设备名称:</span>
          <span>{{FHQXName}}</span>
   ...
   //负荷曲线
    getFZQXData(index,data){
      ...
      this.FHQXName=data.SBMC;
        postFZQX+=this.sbid + '/' + '16' + '/' + this.postData.KSSJ + '/' + this.postData.JSSJ;
