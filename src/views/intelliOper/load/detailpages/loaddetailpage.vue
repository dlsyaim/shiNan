<template>
  <div class="details">
     <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>
              <span @click="back" class="back">负载情况</span>
          </el-breadcrumb-item>
          <el-breadcrumb-item>
              详情
          </el-breadcrumb-item>
    ...
    <div class="table_content">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column fixed prop="relationship " label="查看负载曲线" width="128">
            ...
            <template slot-scope="scope">
              <div @click="getFZQXData(scope.$index,scope.row)" style="cursor: pointer">
                ...
                <span style="color:#ccc;">查看负载曲线</span>
              </div>
              </template>
